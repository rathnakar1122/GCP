...
def file_not_present():
    print(f"Incidents_{current_date}.csv file is not present in GCS bucket")
# query to delete current_date records from RAW_CS_DP_REAL_ESTATE_PROPERTY_INCIDENT
src_sql_1 = f"""DELETE FROM `hsbc-11359979-dbsrefinery-prod.dcoo_cs_analytics_data_prod.RAW_CS_DP_REAL_ESTATE_PROPERTY_INCIDENT` WHERE REPORT_DATE = '{PROCESS_DATE}'"""
#TEMPLATE LOCATION FOR ETL1
TEMPLATE_FOR_ETL1='gs://cs-data-platform-dataflow-prod/df-template/cs-jll-etl-1-incident-work-ds.pb'
#TEMPLATE LOCATION FOR ETL2
TEMPLATE_FOR_ETL2='gs://cs-data-platform-dataflow-prod/df-template/cs-jll-etl-2-incident-work-ds.pb'
...
PARAMETERS_FOR_ETL1={
    ...
    'file_name_with_path':f'gs://cs_data_platform_jll_prod/incident/{current_date}/Incidents_{current_date}.csv',
    }
PARAMETERS_FOR_ETL2={
    'runner':'DataflowRunner',
    'region':'europe-west2',
...
with models.DAG(
    ...
    check_gcs_file = GCSObjectExistenceSensor(
        ...
        object=f'incident/{current_date}/incident_{current_date}.csv',
    ...
    start_cs_jll_etl1_incident_work = DataflowTemplatedJobStartOperator(
        task_id='start_cs_jll_etl1_incident_work',
        template=TEMPLATE_FOR_ETL1,
        job_name='cs_jll_incident_work_etl1',
    ...
    start_cs_jll_etl2_incident_work = DataflowTemplatedJobStartOperator(
        task_id='start_cs_jll_etl2_incident_work',
        template=TEMPLATE_FOR_ETL2,
        job_name='cs_jll_incident_work_etl2',
    ...
    delete_bq_record_RAW >> start_cs_jll_etl1_incident_work
    start_cs_jll_etl1_incident_work >> start_cs_jll_etl2_incident_work
    #Using triggerrule
    file_not_present_task.trigger_rule = TriggerRule.ONE_FAILED
    delete_bq_record_RAW.trigger_rule = TriggerRule.ALL_SUCCESS
    start_cs_jll_etl1_incident_work = TriggerRule.ALL_SUCCESS
    start_cs_jll_etl2_incident_work = TriggerRule.ALL_SUCCESS