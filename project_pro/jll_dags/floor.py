...
#TEMPLATE LOCATION FOR cs-jll-floor
TEMPLATE='gs://cs-data-platform-dataflow-prod/df-template/cs-jll-floor.pb'
...
PARAMETER={
    ...
    'out_file_name_with_path':f'gs://cs_data_platform_jll_prod/out_files/floor/floor-{PROCESS_DATE}'
    }
...
with models.DAG(
    ...
    start_jll_floor = DataflowTemplatedJobStartOperator(
        task_id='start_jll_floor',
        template=TEMPLATE,
        job_name='cs-jll-floor',
