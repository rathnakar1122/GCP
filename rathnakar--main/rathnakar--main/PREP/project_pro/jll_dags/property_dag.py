...
#TEMPLATE LOCATION FOR CS-MIST-REFERENCE-PROPERTY
TEMPLATE='gs://cs-data-platform-dataflow-prod/df-template/cs-mist-reference-property.pb'
...
# Define the DAG
with models.DAG(
    'cs_mist_reference_property_prod_dag',
    ...
    start_mist_reference_property = DataflowTemplatedJobStartOperator(
        task_id='start_mist_reference_property',
        template=TEMPLATE,
        job_name='cs-mist-reference-property',
