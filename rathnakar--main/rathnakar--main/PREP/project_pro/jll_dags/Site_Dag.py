...
#TEMPLATE LOCATION FOR CS-MIST-REFERENCE-SITE
TEMPLATE='gs://cs-data-platform-dataflow-prod/df-template/cs-mist-reference-site.pb'
PARAMETER={
...
# Define the DAG
with models.DAG(
    'cs_mist_reference_site_prod_dag',
    ...
    start_mist_reference_site = DataflowTemplatedJobStartOperator(
        task_id='start_mist_reference_site',
        template=TEMPLATE,
        job_name='cs-mist-reference-site',
