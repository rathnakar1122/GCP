...
#TEMPLATE LOCATION FOR CS-MIST-REFERENCE-PROTON
TEMPLATE='gs://cs-data-platform-dataflow-prod/df-template/cs-mist-reference-proton.pb'
...
# Define the DAG
with models.DAG(
    'cs_mist_reference_proton_prod_dag',
    ...
    start_mist_reference_proton = DataflowTemplatedJobStartOperator(
        task_id='start_mist_reference_proton',
        template=TEMPLATE,
        job_name='cs-mist-reference-proton',
